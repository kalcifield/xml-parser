...
def reset_file():
    ...
    file_name = "presql/pre_addon_nestedkeyval.sql"
    open(file_name, "w").close()
...
def parse_xml_to_json():
    ...
    for addon in addon_list:
        ...
        implemented_structure_uid = "Pre-Addon-1.0.0"
        ...
        for key, val in addon.items():
            ...
            write_to_file("key_value", keyvalue_uid,addon_id ,input_val, implementedrow_uid,object_uid)
            gc.collect()
